...
const Navbar = () => {
    ...
    const {axios,user,setUser,setshowUserLogin,navigate,setsearchQuery,searchQuery,getCartCount,setcardItems}=useAppContext();
  ...
  return (
    <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
            ...
            <NavLink to='/' onClick={()=>setOpen(false)}>
                {/* <img className="h-12 " src={assets.OwnBrand} alt="Logo" /> */}
                <h1 className="text-2xl flex items-center">
                <span className="text-[#15b56a] text-4xl animate-bounce">T</span>
                hinkStore
                </h1>
            </NavLink>
