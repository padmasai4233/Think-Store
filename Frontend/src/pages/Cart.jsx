...
const Cart = () => {
    ...
    const {user,axios,products,currency,cardItems,removeCardItem,getCartCount,updateCardItem,navigate,getCartAmount,setcardItems}=useAppContext();
    ...
    try {
        const { data } = await axios.get('/api/address/get', {
            params: { userId: user._id } // ✅ send userId correctly
        });
        if (data.success) {
                            ...
                            <div>
                                ...
                                <div className="font-normal text-gray-500/70">
                                    ...
                                    <div className='flex items-center'>
                                        <p>Qty:</p>
                                        <select onChange={e=>updateCardItem(product._id,Number(e.target.value))} value={cardItems[product._id]} className='outline-none'>
